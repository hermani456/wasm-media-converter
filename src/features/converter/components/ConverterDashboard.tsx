  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Media Forge</h1>
      ...
      <div className="space-y-4">
        {files.length > 0 && <h2 className="text-lg font-semibold text-slate-700 dark:text-slate-200">Conversion Queue</h2>}
